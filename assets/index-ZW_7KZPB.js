...
function gr(e, n, t, r, l) {
    ...
    if (o)
        ...
        gr(l, n, t, "", function(c) {
            return c
        })) : l != null && (Vi(l) && (l = vc(l, t + (!l.key || o && o.key === l.key ? "" : ("" + l.key).replace(Io, "$&/") + "/") + e)),
        n.push(l)),
        1;
    if (o = 0,
    r = r === "" ? "." : r + ":",
...
T.cloneElement = function(e, n, t) {
    ...
    if (n != null) {
        ...
        for (s in n)
            Ju.call(n, s) && !qu.hasOwnProperty(s) && (r[s] = n[s] === void 0 && u !== void 0 ? u[s] : n[s])
    }
...
(function(e) {
    ...
    function x(E, z) {
        ...
        try {
            for (d(z),
            m = t(s); m !== null && (!(m.expirationTime > z) || E && !Ne()); ) {
                var W = m.callback;
...
function Wi(e, n, t, r) {
    ...
    (l !== null ? l.type !== 0 : r || !(2 < n.length) || n[0] !== "o" && n[0] !== "O" || n[1] !== "n" && n[1] !== "N") && (jc(n, t, l, r) && (t = null),
...
var Ts, Ji, js, Rs, Ms, ai = !1, ur = [], rn = null, ln = null, on = null, Ot = new Map, Dt = new Map, be = [], bc = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
function Yo(e, n) {
    switch (e) {
    case "focusin":
    case "focusout":
...
function ef(e, n, t, r, l) {
    ...
    case "pointerover":
        var i = l.pointerId;
        return Ot.set(i, dt(Ot.get(i) || null, e, n, t, r, l)),
        !0;
    case "gotpointercapture":
        return i = l.pointerId,
        Dt.set(i, dt(Dt.get(i) || null, e, n, t, r, l)),
        !0
    }
    return !1
}
...
function we(e) {
    function n(t, r, l, i, o) {
        ...
        for (var u in e)
            ...
            this[u] = t ? t(i) : i[u]);
        return this.isDefaultPrevented = (i.defaultPrevented != null ? i.defaultPrevented : i.returnValue === !1) ? sr : Go,
...
function Tf(e, n) {
    if (In)
        return e === "compositionend" || !to && Us(e, n) ? (e = Is(),
        Sr = bi = nn = null,
        In = !1,
        e) : null;
    switch (e) {
...
function ru() {
    _t && (_t.detachEvent("onpropertychange", Bs),
    Ft = _t = null)
}
function Bs(e) {
...
function Of(e, n, t) {
    ...
    _t = n,
    Ft = t,
    _t.attachEvent("onpropertychange", Bs)) : e === "focusout" && ru()
}
function Df(e) {
        ...
        if (!(n & 7)) {
            ...
            e: {
                ...
                g === "select" || g === "input" && p.type === "file")
                    ...
                    (g = p.nodeName) && g.toLowerCase() === "input" && (p.type === "checkbox" || p.type === "radio") && (x = If);
                if (x && (x = x(e, c))) {
                    As(m, x, t, h);
                    break e
                }
            ...
            if (to)
                ...
                In ? Us(e, t) && (N = "onCompositionEnd") : e === "keydown" && t.keyCode === 229 && (N = "onCompositionStart");
            N && (Fs && t.locale !== "ko" && (In || N !== "onCompositionStart" ? N === "onCompositionEnd" && In && (_ = Is()) : (nn = h,
...
function au(e, n, t, r, l) {
    for (var i = n._reactName, o = []; t !== null && t !== r; ) {
        ...
        u.tag === 5 && c !== null && (u = c,
        l ? (s = Mt(t, i),
        s != null && o.unshift(At(t, s, u))) : l || (s = Mt(t, i),
    ...
    if (U) {
        ...
        if (n) {
            ...
            if (!hu(e, n)) {
                ...
                n = un(t.nextSibling);
                var r = ve;
                n && hu(e, n) ? ta(r, t) : (e.flags = e.flags & -4097 | 2,
                U = !1,
                ve = e)
            }
        } else {
...
function za(e, n, t) {
    var r = !1
      , l = pn
      , i = n.contextType;
    return typeof i == "object" && i !== null ? i = Ce(i) : (l = de(n) ? Nn : le.current,
    r = n.contextTypes,
...
function Ei(e, n, t, r) {
    ...
    fo(e);
    var i = n.contextType;
    typeof i == "object" && i !== null ? l.context = Ce(i) : (i = de(n) ? Nn : le.current,
    l.context = bn(e, i)),
    l.state = e.memoizedState,
...
function zu(e, n, t, r, l) {
    if (e === null) {
        ...
        n.type = i,
        ja(e, n, i, r, l)) : (e = Lr(t.type, null, r, n, n.mode, l),
        e.ref = n.ref,
        e.return = n,
        n.child = e)
    }
...
function Lu(e, n, t, r, l) {
    ...
    n.stateNode === null)
        ...
        var s = o.context
          , c = t.contextType;
        typeof c == "object" && c !== null ? c = Ce(c) : (c = de(t) ? Nn : le.current,
        c = bn(n, c));
        ...
        p = o.context,
        s = t.contextType,
        typeof s == "object" && s !== null ? s = Ce(s) : (s = de(t) ? Nn : le.current,
        s = bn(n, s));
...
function ad(e, n, t) {
    ...
    case 13:
        ...
        r !== null)
            ...
            n.flags |= 128,
            null) : t & n.child.childLanes ? Da(e, n, t) : (O($, $.current & 1),
            e = Xe(e, n, t),
        ...
        for (c in r) {
            ...
            r.hasOwnProperty(c) && s !== u && (s != null || u != null))
                if (c === "style")
                    ...
                    u = u ? u.__html : void 0,
                    s != null && u !== s && (i = i || []).push(c, s)) : c === "children" ? typeof s != "string" && typeof s != "number" || (i = i || []).push(c, "" + s) : c !== "suppressContentEditableWarning" && c !== "suppressHydrationWarning" && (jt.hasOwnProperty(c) ? (s != null && c === "onScroll" && D("scroll", e),
                ...
                e: {
                    ...
                    for (i in u)
                        if (u.hasOwnProperty(i)) {
                            ...
                            s != null && ms(e, s)) : i === "children" ? typeof s == "string" ? (t !== "textarea" || s !== "") && Rt(e, s) : typeof s == "number" && Rt(e, "" + s) : i !== "suppressContentEditableWarning" && i !== "suppressHydrationWarning" && i !== "autoFocus" && (jt.hasOwnProperty(i) ? s != null && i === "onScroll" && D("scroll", e) : s != null && Wi(e, i, s, o))
                        }
                    switch (t) {
                    case "input":
                        rr(e),
            ...
            s !== null)
                try {
                    ...
                    for (o = 0; o < s.length; o += 2) {
                        var h = s[o]
                          , m = s[o + 1];
                        h === "style" ? vs(l, m) : h === "dangerouslySetInnerHTML" ? ms(l, m) : h === "children" ? Rt(l, m) : Wi(l, h, m, c)
                    }
                    switch (u) {
                    case "input":
                        ql(l, i);
...
function cn(e) {
    return e.mode & 1 ? R & 2 && b !== 0 ? b & -b : qf.transition !== null ? (zr === 0 && (zr = zs()),
    zr) : (e = M,
    e !== 0 || (e = window.event,
...
function kd(e, n, t) {
    ...
    J === e && (b & t) === t && (X === 4 || X === 3 && (b & 130023424) === b && 500 > Q() - Co ? Cn(e, 0) : Eo |= t),
    pe(e, n)
}
function Za(e, n) {
    n === 0 && (e.mode & 1 ? (n = or,
...
Ja = function(e, n, t) {
    if (e !== null)
        ...
        ce = !1,
        U && n.flags & 1048576 && na(n, Br, n.index);
    switch (n.lanes = 0,
    n.tag) {
    case 2:
        var r = n.type;
...
const Md = e => e.replace(/([a-z0-9])([A-Z])/g, "$1-$2").toLowerCase().trim()
  , vl = (e, n) => {
    const t = He.forwardRef( ({color: r="currentColor", size: l=24, strokeWidth: i=2, absoluteStrokeWidth: o, className: u="", children: s, ...c}, h) => He.createElement("svg", {
        ref: h,
        ...Rd,
        width: l,
        height: l,
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const Hu = vl("MessageCircle", [["path", {
...
function Id() {
    const [e,n] = He.useState(3)
      , [t,r] = He.useState(!1)
      , l = "https://discord.gg/stc5ZbYEQB";
    He.useEffect( () => {
        const u = setInterval( () => {
            n(s => s <= 1 ? (r(!0),
            setTimeout( () => {
    ...
    return P.jsxs("div", {
        ...
        children: [P.jsxs("div", {
            ...
            children: [P.jsx("div", {
                ...
                className: "absolute -bottom-40 -left-40 w-80 h-80 bg-indigo-500 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse animation-delay-2000"
            }), P.jsx("div", {
                className: "absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-pink-500 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-pulse animation-delay-4000"
            })]
        }), P.jsxs("div", {
            ...
            children: [P.jsxs("div", {
                ...
                children: [P.jsxs("div", {
                    ...
                    children: [P.jsx("div", {
                        ...
                        children: "Chuyển hướng đến máy chủ Discord"
                    })]
                }), P.jsx("div", {
                    className: "text-center mb-8",
                    children: t ? P.jsxs("div", {
                        className: "space-y-4",
                        children: [P.jsx("div", {
                            className: "w-16 h-16 mx-auto rounded-full border-4 border-white/20 border-t-white animate-spin"
                        }), P.jsx("p", {
                        ...
                        children: [P.jsxs("div", {
                            ...
                            children: [P.jsx("div", {
                                ...
                                children: P.jsx("circle", {
                                    ...
                                    strokeDashoffset: `${2 * Math.PI * 44 * (1 - o / 100)}`,
                            ...
                            className: "text-white/90 font-medium",
                            children: ["Tự động chuyển hướng sau ", e, " giây"]
                        })]
                    })
                }), P.jsxs("div", {
                    className: "space-y-4",
                    children: [P.jsxs("button", {
                        onClick: i,
                        disabled: t,
                        className: "w-full bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-800 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-200 flex items-center justify-center space-x-2 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 disabled:transform-none",
                        children: [P.jsx(Wu, {
                            size: 20
                        }), P.jsx("span", {
                            children: "Tham gia Discord ngay"
                        }), P.jsx(Od, {
                            size: 20
                        })]
                    }), P.jsxs("div", {
                        ...
                        children: [P.jsx("p", {
                            ...
                            children: "Hoặc sao chép liên kết:"
                        }), P.jsxs("div", {
                            className: "flex items-center bg-white/10 rounded-lg p-3 border border-white/20",
                            children: [P.jsx("code", {
                                className: "flex-1 text-white/90 text-sm font-mono truncate",
                                children: l
                            }), P.jsx("button", {
                                onClick: () => navigator.clipboard.writeText(l),
                                className: "ml-2 p-1 hover:bg-white/20 rounded text-white/80 hover:text-white transition-colors",
                    ...
                    children: P.jsx("p", {
                        ...
                        children: "Nếu trang không tự động chuyển hướng, vui lòng nhấn vào nút bên trên hoặc sao chép liên kết."
                    })
                })]
            }), P.jsxs("div", {
                ...
                children: [P.jsxs("div", {
                    ...
                    children: [P.jsxs("div", {
                        ...
                        children: "Tham gia và kết nối với mọi người"
                    })]
                }), P.jsxs("div", {
                    className: "bg-white/5 backdrop-blur-sm rounded-xl p-4 border border-white/10",
                    children: [P.jsxs("div", {
                        ...
                        className: "text-white/70 text-xs",
                        children: "Thảo luận và chia sẻ kinh nghiệm"
                    })]
                })]
            })]
        })]
...
rc(document.getElementById("root")).render(P.jsx(He.StrictMode, {
    children: P.jsx(Id, {})
}));
